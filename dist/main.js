...
const transform_interceptor_1 = __webpack_require__(22);
const base_exception_filter_1 = __webpack_require__(24);
const http_exception_filter_1 = __webpack_require__(25);
const doc_1 = __webpack_require__(26);
const platform_fastify_1 = __webpack_require__(29);
async function bootstrap() {
    const app = await core_1.NestFactory.create(app_module_1.AppModule, new platform_fastify_1.FastifyAdapter());
    app.enableVersioning({
        defaultVersion: [common_1.VERSION_NEUTRAL, '1', '2', '3'],
...
const common_1 = __webpack_require__(5);
const user_service_1 = __webpack_require__(10);
const create_user_dto_1 = __webpack_require__(12);
const update_user_dto_1 = __webpack_require__(13);
const business_exception_1 = __webpack_require__(15);
const config_1 = __webpack_require__(17);
let UserController = class UserController {
    ...
    getTestName() {
        return this.configService.get('TEST_VALUE').name + '1231121212122';
    }
    update(id, updateUserDto) {
...
const common_1 = __webpack_require__(5);
const business_error_codes_1 = __webpack_require__(16);
...
const yaml_1 = __webpack_require__(19);
...
const packageConfig = __importStar(__webpack_require__(28));
...
"use strict";
module.exports = JSON.parse('{"name":"nestJS","version":"0.0.1","description":"","author":"","private":true,"license":"UNLICENSED","scripts":{"build":"nest build","format":"prettier --write \\"src/**/*.ts\\" \\"test/**/*.ts\\"","start":"nest start","start:dev":"cross-env RUNNING_ENV=dev nest start --watch","start:hotdev":"cross-env RUNNING_ENV=dev nest build --webpack --webpackPath webpack-hmr.config.js --watch","start:debug":"nest start --debug --watch","start:prod":"node dist/main","lint":"eslint \\"{src,apps,libs,test}/**/*.ts\\" --fix","test":"jest","test:watch":"jest --watch","test:cov":"jest --coverage","test:debug":"node --inspect-brk -r tsconfig-paths/register -r ts-node/register node_modules/.bin/jest --runInBand","test:e2e":"jest --config ./test/jest-e2e.json"},"dependencies":{"@fastify/static":"^6.6.1","@nestjs/common":"^9.0.0","@nestjs/config":"^2.2.0","@nestjs/core":"^9.0.0","@nestjs/mapped-types":"*","@nestjs/platform-express":"^9.0.0","@nestjs/platform-fastify":"^9.2.1","@nestjs/swagger":"^6.1.4","cross-env":"^7.0.3","reflect-metadata":"^0.1.13","run-script-webpack-plugin":"^0.1.1","rxjs":"^7.2.0","webpack":"^5.75.0","webpack-node-externals":"^3.0.0","yaml":"^2.2.1"},"devDependencies":{"@nestjs/cli":"^9.0.0","@nestjs/schematics":"^9.0.0","@nestjs/testing":"^9.0.0","@types/express":"^4.17.13","@types/jest":"29.2.4","@types/node":"^18.11.18","@types/supertest":"^2.0.11","@typescript-eslint/eslint-plugin":"^5.0.0","@typescript-eslint/parser":"^5.0.0","eslint":"^8.0.1","eslint-config-prettier":"^8.3.0","eslint-plugin-prettier":"^4.0.0","jest":"29.3.1","prettier":"^2.3.2","source-map-support":"^0.5.20","supertest":"^6.1.3","ts-jest":"29.0.3","ts-loader":"^9.2.3","ts-node":"^10.0.0","tsconfig-paths":"4.1.1","typescript":"^4.7.4"},"jest":{"moduleFileExtensions":["js","json","ts"],"rootDir":"src","testRegex":".*\\\\.spec\\\\.ts$","transform":{"^.+\\\\.(t|j)s$":"ts-jest"},"collectCoverageFrom":["**/*.(t|j)s"],"coverageDirectory":"../coverage","testEnvironment":"node"}}');
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("ee034431b46ae95d3416")
/******/ 	})();
/******/ 	
